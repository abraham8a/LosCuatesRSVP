...
const EVENTS = {
  full: {
    ...
    calStart:      '20260809T000000Z',  // Aug 8 6PM CDT
    calEnd:        '20260809T040000Z',  // 11PM CDT
    calStartLocal: '2026-08-08T18:00:00',
    calEndLocal:   '2026-08-08T23:00:00',
  },
  dance: {
    eventTitle:    'Benjamin & Valerie Ochoa Grad Party — Dance',
    eventDate:     'Saturday, August 8 · Dance 7–11 PM',
    eventLocation: 'Casa de Amistad · 1204 Fair Park Blvd, Harlingen, TX 78550',
    calStart:      '20260809T000000Z',  // Aug 8 7PM CDT
    calEnd:        '20260809T040000Z',  // 11PM CDT
    calStartLocal: '2026-08-08T19:00:00',
    calEndLocal:   '2026-08-08T23:00:00',
  },
};

const eventType = new URLSearchParams(window.location.search).get('event') === 'dance' ? 'dance' : 'full';
...
if (form) {
  ...
  function buildCalendarLinks() {
    var start   = CONFIG.calStart;
    var end     = CONFIG.calEnd;
    ...
    document.getElementById('cal-outlook').href =
      ...
      '&startdt=' + CONFIG.calStartLocal + '&enddt=' + CONFIG.calEndLocal +
      '&location=' + loc + '&body=' + details;
  }
}
