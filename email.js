...
async function sendRsvpEmails(guest) {
  ...
  const calLink = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(CONFIG.eventTitle)}&dates=20260809T000000Z/20260809T040000Z&location=${encodeURIComponent(CONFIG.eventLocation)}&details=${encodeURIComponent('We look forward to celebrating with you!')}`;
